...
export default function About() {
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-green-50 to-orange-50 mt-[80px] py-20 px-6 text-gray-800 font-[Montserrat]">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-green-800 font-[Courgette]">
            About Us
          </h1>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition duration-300">
            <h3 className="text-xl font-semibold text-green-700 mb-2 font-[Poppins]">
              Our Mission
            </h3>
